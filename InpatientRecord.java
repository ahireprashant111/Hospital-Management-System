...
public class InpatientRecord extends JFrame implements ActionListener

{
	 ...
	 setBounds(0,0,1020,725);
	  ...
	  stop=new JLabel("Smt. Kashibai Navle Health Center");
	  ...
	  setVisible(true);
       ...
       public void actionPerformed(ActionEvent ae)
		...
		PreparedStatement psms=ms.prepareStatement("insert into inpacaserec(pname,page,psex,poccu,popno,pdoa,pdod,pdia,pda,ppc,pph,ppe,pi) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
 ...
 public static void main(String args[])

      {
           ...
           InpatientRecord d=new InpatientRecord();
