 ...
 public  class medicine extends JFrame implements ActionListener
	...
	
   {
	...
	//   setMinimumSize(new java.awt.Dimension(1020,720));
	   ...
	   ds=new JLabel(" Smt. Kashibai Navle Medicine Store ");
	   ...
	   ima.setIcon(new ImageIcon("drug-store.jpg"));
                   ...
                   getContentPane().add(ima);
                    ...
                    indg=new JButton("Insert Medicine");
	   ...
	   indg.setForeground(new Color(0,0,255));
                    ...
                    updg=new JButton("Update  Medicine ");
       ...
       public void actionPerformed(ActionEvent ae)
  
             {
	          ...
	          if(ae.getActionCommand().equals("BACK"))
        	      ...
        	      else if(ae.getActionCommand().equals("Insert Medicine"))
                ...
                else if(ae.getActionCommand().equals("Update  Medicine "))
