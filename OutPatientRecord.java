...
public class OutPatientRecord extends JFrame implements ActionListener
...
{    
     ...
     public OutPatientRecord()
	  ...
	  head=new JLabel("Smt. Kashibai Navle Health Center");
           ...
           if(ae.getActionCommand().equals("Exit"))

              {
...

			   {
			      ...
			      PreparedStatement psms=ms.prepareStatement("insert into opregister(pname,page,popno,pdate,psex,poccu,pdiag)values(?,?,?,?,?,?,?)");
  ...
  public static void main(String args[])
  
      {
          ...
          OutPatientRecord i=new OutPatientRecord();
